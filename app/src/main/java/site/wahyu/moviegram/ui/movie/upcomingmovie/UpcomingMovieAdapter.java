...
public class UpcomingMovieAdapter extends RecyclerView.Adapter<UpcomingMovieAdapter.UpcomingMovieHolder> {
    ...
    private OnUpcomingMovieItemClicked clickHandler;
    private boolean onFragmentMovieMore;

    public void setClickHandler(OnUpcomingMovieItemClicked clickHandler) {
    ...
    public UpcomingMovieHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new UpcomingMovieAdapter.UpcomingMovieHolder(view);
    }
    ...
    class UpcomingMovieHolder extends RecyclerView.ViewHolder {
        ...
        UpcomingMovieHolder(@NonNull View itemView) {
            super(itemView);
            ...
            itemView.setOnClickListener(view -> {
                ...
                clickHandler.upcomingMovieItemClicked(m);
            });
        }
    }

    public interface OnUpcomingMovieItemClicked{
        void upcomingMovieItemClicked(Movie m);
    }
