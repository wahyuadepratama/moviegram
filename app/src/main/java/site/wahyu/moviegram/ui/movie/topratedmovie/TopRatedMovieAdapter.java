...
public class TopRatedMovieAdapter extends RecyclerView.Adapter<TopRatedMovieAdapter.TopRatedMovieHolder> {
    ...
    private OnTopRatedMovieItemClicked clickHandler;
    private boolean onFragmentMovieMore;

    public void setClickHandler(OnTopRatedMovieItemClicked clickHandler) {
        this.clickHandler = clickHandler;
    }

    public void setListMovie(List<Movie> listMovie, boolean onFragmentMovieMore) {
    ...
    public TopRatedMovieHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new TopRatedMovieAdapter.TopRatedMovieHolder(view);
    }
    ...
    class TopRatedMovieHolder extends RecyclerView.ViewHolder {

        ImageView poster;
        LinearLayout linearLayout;

        TopRatedMovieHolder(@NonNull View itemView) {
            super(itemView);
            ...
            itemView.setOnClickListener(view -> {
                ...
                clickHandler.topRatedMovieItemClicked(m);
            });
        }
    }

    public interface OnTopRatedMovieItemClicked{
        void topRatedMovieItemClicked(Movie m);
    }
